<div class="card">
    <div class="card-header bg-info">
        <h4 class="text-center">PROSES PENGADAAN BARANG DAN JASA PAKET NON STRATEGIS (>RP. 200 JUTA S/D Rp. 2,5 M)</h4>
    </div>
    <div class="card-body collapse show">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <select class="form-control custom-select" id="bln_ppbj_200">
                ...
                <button type="button" class="btn waves-effect waves-light btn-sm btn-success" onclick="ReloadPpbj200()"><i class="mdi mdi-loop"></i> Refresh</button>
                <button type="button" class="btn waves-effect waves-light btn-sm btn-primary" onclick="CetakPpbj200()"><i class="mdi mdi-printer"></i> Cetak</button>
        ...
        <div class="table-responsive">
            <table id="TblPpbj200Admin" class="table-bordered" width="100%" cellpadding="5">
                <thead>
