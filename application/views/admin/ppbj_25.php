<div class="card">
    <div class="card-header bg-info">
        <h4 class="text-center">PROSES PENGADAAN BARANG DAN JASA PAKET NON STRATEGIS (>RP. 25 JUTA S/D Rp. 2,5 M)</h4>
    </div>
    <div class="card-body collapse show">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <select class="form-control custom-select" id="bln_ppbj_25">
                ...
                <button type="button" class="btn waves-effect waves-light btn-sm btn-success" onclick="ReloadPpbj25()"><i class="mdi mdi-loop"></i> Refresh</button>
                <button type="button" class="btn waves-effect waves-light btn-sm btn-primary" onclick="CetakPpbj25()"><i class="mdi mdi-printer"></i> Cetak</button>
        ...
        <div class="table-responsive">
            <table id="TblPpbj25Admin" class="table-bordered" width="100%" cellpadding="5">
                <thead>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h5>PROSES PENGADAAN BARANG DAN JASA PAKET NON STRATEGIS (>RP. 50 JUTA S/D Rp. 25 JUTA)</h5>
