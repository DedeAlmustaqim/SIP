...
<body>
    ...
    <table border="1" width="100%" cellpadding="2" class="text_utama">
        ...
        <tr>
            ...
            <td class="text-center"><?php echo $jml_pkt_200 ?></td>
            <td class="text-right"><?php echo rupiah($jml_pg_200) ?></td>
            <td class="text-center"><?php echo $pl_pkt_200 ?></td>
            <td class="text-right"><?php echo rupiah($pl_rp_200) ?></td>
            <td class="text-center"><?php echo $h_pl_pkt_200 ?></td>
            <td class="text-right"><?php echo rupiah($h_pl_rp_200) ?></td>
            <td class="text-center"><?php echo $kontrak_pkt_200 ?></td>
            <td class="text-right"><?php echo rupiah($kontrak_rp_200) ?></td>
            <td class="text-center"><?php echo $st_pkt_200 ?></td>
            <td class="text-right"><?php echo rupiah($st_rp_200) ?></td>
            <td class="text-center"><?php echo $bp_pkt_200 ?></td>
            <td class="text-right"><?php echo rupiah($bp_rp_200) ?></td>
