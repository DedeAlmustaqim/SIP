    ...
    <table border="1" width="100%" cellpadding="5">
        ...
        <tr>
            <?php foreach ($main as $u) { ?>
                ...
                <th width="3%" class="text-center"><?php echo $u->jml_pkt_50 ?></th>
                <th class="text-right"><?php echo rupiah($u->jml_pg_50) ?></th>
                <th width="3%" class="text-center"><?php echo $u->pl_pkt_50 ?></th>
                <th class="text-right"><?php echo rupiah($u->pl_rp_50) ?></th>
                <th width="3%" class="text-center"><?php echo $u->h_pl_pkt_50 ?></th>
                <th class="text-right"><?php echo rupiah($u->h_pl_rp_50) ?></th>
                <th width="3%" class="text-center"><?php echo $u->kontrak_pkt_50 ?></th>
                <th class="text-right"><?php echo rupiah($u->kontrak_rp_50) ?></th>
                <th width="3%" class="text-center"><?php echo $u->st_pkt_50 ?></th>
                <th class="text-right"><?php echo rupiah($u->st_rp_50) ?></th>
                <th width="3%" class="text-center"><?php echo $u->bp_pkt_50 ?></th>
                <th class="text-right"><?php echo rupiah($u->bp_rp_50) ?></th>
            <?php } ?>
        </tr>
    </table>
