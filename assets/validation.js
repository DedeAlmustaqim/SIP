                ...
                return this.each(function () {
                    ...
                    if (settings.options.sniffHtml) {
                        ...
                        if ($this.attr("maxlength") !== undefined) {
                            message = "Terlalu Panjang: Maximum of '" + $this.attr("maxlength") + "' Karakter<!-- data-validation-maxlength-message to override -->";
                        ...
                        if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "email") {
                            message = "Alamat Email tidak valid<!-- data-validation-email-message to override -->";
        ...
        , validatorTypes: {
            ...
            , match: {
                ...
                , init: function ($this, name) {
                    ...
                    var message = "Password harus sama";
                    var $label = null;
